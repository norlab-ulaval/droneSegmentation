...
fig.savefig(
    "lowAltitude_classification/figs/phase2/phase2-val-test-DifferentStepSize.pdf"
)
fig.savefig(
    "lowAltitude_classification/figs/phase2/phase2-val-test-DifferentStepSize.png"
)
