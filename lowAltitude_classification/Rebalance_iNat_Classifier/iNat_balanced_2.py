...
log_file_path = "/home/kamyar/PycharmProjects/droneSegmentation/lowAltitude_classification/Rebalance_iNat_Classifier/log_rebalance1.txt"
...
for fold, (train_idx, val_idx) in enumerate(kf.split(dataset, dataset.targets)):
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            pth_name = (
                f"31{fold + 1}_balanced1_time{t}_{epoch + 1}e_acc{100 * accuracy:2.0f}.pth"
            )
            torch.save(
                model_weights,
