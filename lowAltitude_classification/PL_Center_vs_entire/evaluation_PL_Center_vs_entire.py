...
pred_folder =  Path('/home/kamyar/Documents/PL_Center_vs_entire/Train-val')
...
df.to_csv(f"lowAltitude_classification/PL_Center_vs_entire/PL_Center_vs_entire_{pred_folder.name}.csv",
          index=False)