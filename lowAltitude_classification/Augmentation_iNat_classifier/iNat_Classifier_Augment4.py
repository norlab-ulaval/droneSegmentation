...
from albumentations import (
    ...
    Compose, CenterCrop, ColorJitter, Blur, RandomBrightnessContrast, ShiftScaleRotate, Perspective
)
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(dataset, dataset.targets)):
        ...
        for epoch in range(num_epochs):
            ...
            with torch.no_grad():
                ...
                pth_name = f"23{fold + 1}_aug3_time{t}_{epoch + 1}e_acc{100 * accuracy:2.0f}.pth"
