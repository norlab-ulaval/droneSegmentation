...
bars1 = ax1.bar(central_sizes_labels, filtered_val.F1, color='teal', width=0.4, edgecolor='black')
...
bars2 = ax2.bar(central_sizes_labels, filtered_test.F1, color='teal', width=0.4, edgecolor='black')
