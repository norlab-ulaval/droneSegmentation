...
ax1.bar(patch_size_labels, df_val_filtered.F1, color='slateblue', width=0.3, edgecolor='black')
...
ax2.bar(patch_size_labels, df_test_filtered.F1, color='slateblue', width=0.3, edgecolor='black')
