...
model.load_state_dict(torch.load("checkpoints/filtered_inat.pth"))
model.eval()
...
for patch_size in patch_sizes:
    for overlap in overlaps:
        ...
        output_folder = (
            f"data/Test_pred/patch_{patch_size}_overlap_{int(overlap * 100)}"
        )
                    ...
                    for y in range(0, padded_height - patch_size + 1, step_size):
                        ...
                        if len(patches) == batch_size:
                            ...
                            for patch_idx, (x, y) in enumerate(coordinates):
                                ...
                                pixel_predictions[(center_x, center_y)].append(
                                    predicted_class
                                )
