...
# ax1.set_title(r'\datasetDroneVal')
...
fig.savefig('lowAltitude_classification/figs/phase2/phase2-val-test-center.pdf')
fig.savefig('lowAltitude_classification/figs/phase2/phase2-val-test-center.png')
