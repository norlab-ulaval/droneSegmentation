...
test_image_folder = Path("/home/kamyar/Documents/GSD_Gaussian/images/")
test_annotation_folder = Path("/home/kamyar/Documents/Test_Annotated_masks_updated")
output_csv_path = 'lowAltitude_classification/GSD_Gaussian_pyramid/GSD_Gaussian_pyramid.csv'
        ...
        if weight_file.endswith('.pth'):
            ...
            for patch_size in patch_sizes:
                for overlap in overlaps:
                    for subdir in os.listdir(test_image_folder):
                        test_folder = os.path.join(test_image_folder, subdir)

                        total_pixels_test, correct_predictions_test, y_true_test, y_pred_test = process_images(
                            test_folder, test_annotation_folder, [], [], 0, 0, 'Testing', model, patch_size=patch_size, overlap=overlap)
