...
# Paths
results_dir = Path(
    "lowAltitude_classification/Cls_Different_Techniques/CLS_primary_csv_stages_evaluation/"
)
parent_weights_folder = Path(
    "lowAltitude_classification/results_Journal_classifier_weights"
)
                    ...
                    for patch_idx, (x, y) in enumerate(coordinates):
                        ...
                        for px, py in pixel_coords:
                            if 0 <= px < width and 0 <= py < height:
                                true_label = patch_annotation[py - y, px - x]
                ...
                for patch_size in patch_sizes:
                    for overlap in overlaps:
                        ...
                        if total_pixels_val > 0:
                            ...
                            print(
                                f"No validation pixels were processed for weight file {weight_file_path.name} with patch size {patch_size} and overlap {overlap}."
                            )
