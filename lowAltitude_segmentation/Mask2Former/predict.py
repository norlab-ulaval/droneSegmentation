...
class Predictor():
    def setup(self):
        ...
        cfg.MODEL.WEIGHTS = '/home/kamyar/Documents/M2F_Results/PL_V1_PRETRAIN/model_best.pth'
        cfg.MODEL.MASK_FORMER.TEST.SEMANTIC_ON = True
        cfg.MODEL.MASK_FORMER.TEST.INSTANCE_ON = False
        cfg.MODEL.MASK_FORMER.TEST.PANOPTIC_ON = False
        self.predictor = DefaultPredictor(cfg)
...
output_directory = '/home/kamyar/Documents/M2F_Results/PL_V1_PRETRAIN/output_test_verify'
