...
class Predictor():
    def setup(self):
        ...
        cfg.merge_from_file(
            "lowAltitude_segmentation/Mask2Former/configs/Drone_regrowth/semantic-segmentation/swin/M2F_Swin_Large_base_finetuning.yaml", allow_unsafe=True)

        cfg.MODEL.WEIGHTS = '/home/kamyar/Documents/M2F_Results/Swin_finetune_v2/model_best.pth'
        cfg.MODEL.MASK_FORMER.TEST.SEMANTIC_ON = True
        cfg.MODEL.MASK_FORMER.TEST.INSTANCE_ON = False
        cfg.MODEL.MASK_FORMER.TEST.PANOPTIC_ON = False
        self.predictor = DefaultPredictor(cfg)
...
output_directory = '/home/kamyar/Documents/M2F_Results/Swin_base_newConfig/output_test'
