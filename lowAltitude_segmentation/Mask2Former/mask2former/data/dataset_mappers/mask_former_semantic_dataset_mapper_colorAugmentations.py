...
__all__ = ["MaskFormerSemanticDatasetMapperColorAugmentations"]


class MaskFormerSemanticDatasetMapperColorAugmentations:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        if "sem_seg_file_name" in dataset_dict:
            ...
            # plt.show()
            # exit()
            sem_seg_gt = np.squeeze(sem_seg_gt, axis=-1)
        else:
            sem_seg_gt = None
